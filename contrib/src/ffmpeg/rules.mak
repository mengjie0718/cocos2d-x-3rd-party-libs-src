...
configure_option=--prefix=$(PREFIX) --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --enable-opengl --enable-static --pkg-config-flags="--static" --enable-nonfree
